#ifndef _SERIALIZATION_TYPE_TRAITS_HPP_
#define _SERIALIZATION_TYPE_TRAITS_HPP_
...
namespace alex::serialization::type_traits
{
    namespace detail
    {
        ...
        { static constexpr bool value{std::is_base_of<MainObject, T>::value && has_valid_getObjectName_setObjectName_methods<T>::value}; };
...
#endif // _SERIALIZATION_TYPE_TRAITS_HPP_